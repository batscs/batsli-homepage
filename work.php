...
<html>
    ...
    <div style="width: 100%;">
        ...
        <center>
            ...
            <div class="flex-container" style="max-width: 1250px; margin-top: 20px; margin-bottom: 70px;">
                ...
                <?php drawCard("MRG-Tests", ["favorites", "webdev"], $filter, "Feb 2022 - Jun 2022",  "A school project made for verifying if a student has a valid test result by the teacher by scanning a QR-Code", "https://mrg.bats.li", "https://github.com/batscs/MRG-Tests", "mrg_tests.png")?>
                <?php drawCard("py_bounty", ["favorites", "software"], $filter, "Jan 2022",  "A Python made gambling simulation capable of playing roulette and blackjack with virtual money as a demonstration", "https://github.com/batscs/py_bounty", "https://github.com/batscs/py_bounty", "py_bounty.png")?>
                
                <?php drawCard("Halbgeist", ["webdev"], $filter,  "Jul 2021 - Aug 2021",  "Concept website for a cloud server providing service, specialized for gaming servers such as Minecraft, Terraria, etc.", "https://halbgeist.bats.li", "https://github.com/batscs/halbgeist-hosting", "halbgeist.png")?>
                ...
                <?php drawCard("maxohno.de", ["webdev"], $filter,  "Oct 2020 - Nov 2020",  "Website for the Typing Hell Java game with a leaderboard integration to compare your stats with others", "https://maxohno.de/typing/leaderboard.php", "https://github.com/batscs/maxohno.de", "maxohno-de.png")?>
                <?php drawCard("Typing Hell", ["favorites", "software"], $filter,  "Oct 2020 - Nov 2020",  "Type Racer Game inspired by Tetris made in Java with online cloud syncing and more!", "https://steambats.itch.io/Typing-Hell", "https://github.com/batscs/Typing-Hell", "typing-hell.png")?>
