    ...
    <div style="width: 100%;">
        ...
        <center>
            ...
            <div class="flex-container" style="max-width: 1250px; margin-top: 10px; margin-bottom: 70px;">
                ...
                <?php drawCard("py_bounty", ["python"], ["favorites", "software"], $filter, "Jan 2022",  "A Python made gambling simulation capable of playing roulette and blackjack with virtual money as a demonstration", "https://github.com/batscs/py_bounty", "https://github.com/batscs/py_bounty", "py_bounty.png")?>
                ...
                <?php drawCard("Typing Hell", ["java", "mysql"], ["favorites", "software"], $filter,  "Oct 2020 - Nov 2020",  "Type Racer Game inspired by Tetris made in Java with online cloud syncing and more!", "https://steambats.itch.io/Typing-Hell", "https://github.com/batscs/Typing-Hell", "typing-hell.png")?>
